...
<Cards>
  ...
  <Cards.Card title="Read with REST" href="/docs/reading/rest" arrow>
  ...
  <Cards.Card title="Read cross-contract" href="/docs/reading/on-chain" arrow>
    Consume a feed from your own Casper contract.
  </Cards.Card>
  <Cards.Card title="Read with x402" href="/docs/reading/x402" arrow>
