...
The facet `description` tells you what a facet means; this is enough to pick the right facet id. You can browse all 232 datasets visually in the app at [/datasets](/datasets), and the 38 live feeds at [/feeds](/feeds).
