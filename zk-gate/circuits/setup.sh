...
$SNARKJS powersoftau contribute pot16_0000.ptau pot16_final.ptau --name="ProofYield dev ceremony" -e="proofyield-$(head -c16 /dev/urandom | xxd -p)" >/dev/null 2>&1
...
$SNARKJS zkey contribute eligibility_0000.zkey eligibility_final.zkey --name="ProofYield dev ceremony" -e="proofyield-$(head -c16 /dev/urandom | xxd -p)" >/dev/null 2>&1
